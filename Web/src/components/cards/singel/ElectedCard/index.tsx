...
const ElectedCard: React.FC<ElectedCardProps> = ({ players, index, correctMovie }) => {
    ...
    const { scope } = useCardsResultAnimation(finish, getCorrectPlayers(players, index, id));
